...
export const strings = {
  ...
  stats: {
    ...
    pageSubtitle: "Local-only — computed from your browser history.",
    empty: {
      title: "Nothing to chart yet",
      body: "Analyse a few postings, the dashboard fills in automatically.",
    },
    totalAnalyses: "Postings analysed",
    averageScore: "Avg verdict",
    applyToInterview: "Apply → Interview",
  ...
  digest: {
    ...
    sectionHint:
      "Owner-only. A short Monday-morning nudge with a link to /stats. No analysis data is sent.",
    enabledLabel: "Send me a weekly check-in",
    emailLabel: "Recipient email",
    emailPlaceholder: "you@example.com",
    notConfigured:
      "Server isn't configured yet — set RESEND_API_KEY and provision Vercel KV first.",
    saved: "Digest preferences saved.",
    sendNow: "Send a test now",
    sending: "Sending…",
    sent: "Test sent.",
    failed: "Couldn't send the test email.",
  },
  gmail: {
    scanCta: "Scan Gmail for recruiters",
    scanning: "Scanning your inbox…",
    daysLabel: "Last 14 days",
    notConnected: "Connect Google in your profile first.",
    failed: "Gmail scan failed.",
    empty: "No recruiter-looking emails found in the window.",
    foundCount: (n: number) =>
      `${n} recruiter-looking email${n === 1 ? "" : "s"} found`,
    domainBadge: "Known recruiter",
    keywordBadge: (n: number) => `${n} keyword${n === 1 ? "" : "s"}`,
    openInGmail: "Open in Gmail",
    analyse: "Analyse posting",
    dismiss: "Dismiss",
  },
  calendar: {
    addEvent: "Add to Google Calendar",
    creating: "Creating event…",
    created: "Event created",
    failed: "Couldn't create the event.",
    notConnected: "Connect Google in your profile first.",
    noDate: "Set a date on the next action first.",
